...
$(document).ready(function()
{
	...
	*/
	...
	{
		if($('.instructor_slider').length)
		{
			var instructorSlider = $('.instructor_slider');
			...
			if ($('.instructor_prev').length)
			{
				var prev = $('.instructor_prev');

				prev.on('click', function()
				{
					instructorSlider.trigger('prev.owl.carousel');
				});
			}

			if ($('.instructor_next').length)
			{
				var next = $('.instructor_next');
				next.on('click', function()
				{
					instructorSlider.trigger('next.owl.carousel');
				});
			}
		}
	}
